...
The Privacy Policy for this chatbot can be found here. Jovian does not require the users to sign up into new accounts (some third-parties may require signingup). No cloud functions provided by Firebase are used for developing this bot
